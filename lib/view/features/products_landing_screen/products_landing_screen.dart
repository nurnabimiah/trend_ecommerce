...
class ProductsLandingScreen extends StatefulWidget {
  static const String routeName = '/ProductsLandingScreen';
  const ProductsLandingScreen({super.key});

  @override
  State<ProductsLandingScreen> createState() => _ProductsLandingScreenState();
}

class _ProductsLandingScreenState extends State<ProductsLandingScreen> {
  final controller = Get.find<ProductsLandingController>();
  bool _isLoading = false;


  @override
  Widget build(BuildContext context) {
    return GetBuilder<ProductsLandingController>(
      builder: (controller) {
            ...
            headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
              return <Widget>[
                SliverAppBar(
                  ...
                  title: Text(controller.appBarTitle, style: myTxt15(color: whiteOnly, fontWeight: FontWeight.w600),),
                  centerTitle: true,
